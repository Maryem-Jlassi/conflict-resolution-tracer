...
Provides detailed failure analysis and reporting for CRT benchmarks and experiments.
...
class FailureType(Enum):
    """Categories of failures in the CRT system."""
...
class FailureReporter:
    """
    Collects and analyzes failure modes across CRT operations.
