"""CRT Event system — enables the Inspector to observe CRT internals without controlling them."""
...
class EventType(str, Enum):
    ...
    PENDING_DEFEATED      = "PENDING_DEFEATED"
    PENDING_RETAINED      = "PENDING_RETAINED"
    PENDING_PROMOTED      = "PENDING_PROMOTED"
    PENDING_COALESCED     = "PENDING_COALESCED"
...
@dataclass
class LCMEvent:
    """A single observable event emitted by the CRT Core.
